...
import NonfungiblePositionManagerABI from './abis/xswap-none-fungible-position-manager.json'
...
export abstract class NonfungiblePositionManager {
  public static INTERFACE: Interface = new Interface(NonfungiblePositionManagerABI)
